...
<label>Theme <select id="theme"><option value="0">Original / native</option><option value="1">White</option><option value="2">Cyberpunk</option><option value="3">Neon</option><option value="4">Mocha</option><option value="5">Aurora</option><option value="6">Sandstone</option><option value="7">Game Boy</option><option value="8">Super Nintendo</option><option value="9">Windows 95</option><option value="10">Game Boy Color</option><option value="11">Aqua / iTunes</option></select></label>
<nav id="pages"></nav><img id="screen" src="theme-0-stems.png" width="800" height="480" alt="Stems page preview"><small id="caption"></small>
<h2>Two-deck stem rows</h2><p>Two 48-pixel rows. Tap to mute; slide to change the stem volume. Bypass applies to its own deck.</p><img id="inline" src="theme-0-inline.png" width="536" height="96" alt="Two stem control rows, one for each deck">
