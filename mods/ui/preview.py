...
<h2>Compact stems row</h2><p>536 × 64 pixels, prepared for the native waveform area. Native placement and touch integration still need hardware validation.</p><img id="inline" src="theme-0-inline.png" width="536" height="64" alt="Compact stems control row">
