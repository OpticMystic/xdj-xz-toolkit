...
<h2>Two-deck stem rows</h2><p>Two 32-pixel rows for Deck 1 and Deck 2. Each has Vocals, Harmonics, Drums and Bypass. Native placement and touch still need physical acceptance.</p><img id="inline" src="theme-0-inline.png" width="536" height="64" alt="Two stem control rows, one for each deck">
