...
int main(void) {
    for(unsigned y=0;y<10;y++) {
        assert(xz_wave_source_row(y,84)==y);
        assert(xz_wave_source_row(y+74,84)==y+122);
        assert(xz_wave_source_row(y+132,84)==y+136);
        assert(xz_wave_source_row(y+206,84)==y+258);
    }
    assert(xz_wave_source_row(132,84)==136);
    assert(xz_wave_source_row(215,84)==267);
    assert(xz_wave_source_row(999,84)==267);
    for (unsigned height=21;height<=86;height++) {
        native_redraw();
    ...
    assert(!xz_wave_compact(pixels,540*268,540,87));
