...
int main(void){
    ...
    contact(self,200,80,1);assert(last_stock.x==200&&last_stock.y==18+xz_wave_source_row(62,92));
    contact(self,200,180,1);assert(last_stock.y==18+xz_wave_source_row(91,92));contact(self,200,180,0);
    contact(self,200,180,1);assert(last_stock.y==18+xz_wave_source_row(162,92));
    contact(self,200,130,1);assert(last_stock.y==18+xz_wave_source_row(132,92));contact(self,200,130,0);
